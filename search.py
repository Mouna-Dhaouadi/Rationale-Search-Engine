...
text_search_d_cont = col3_1.text_input("Search Contradictory decisions", value="")
...
# Search Rationales
text_search_r_cont = col4.text_input("Search their rationales", value="")
...
m1_container.write('Similar Decisions But Contradictory Rationales')
...
m2_container.write('Contradictory Decisions But Similar Rationales')
